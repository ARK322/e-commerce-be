...
import { PAYMENT_STATUSES } from '@/infrastructure/mongo/models/ecommerce/payment.model';
import type { PaymentStatus } from '@/infrastructure/mongo/models/ecommerce/payment.model';
