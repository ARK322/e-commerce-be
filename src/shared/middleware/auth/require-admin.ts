...
import { hasPermission } from '@/domains/identity/application/access/admin/permissions';
import { getAdminContext, type AdminAccessContext } from '@/domains/identity/application/queries/admin-context';
