...
import { verifyPasswordResetToken } from '@/domains/identity/application/tokens/email-token';
...
import { activateInvitedSellerAfterPasswordReset } from '@/domains/identity/application/members/activate-invited-seller';
import type { ResetPasswordInput } from '@/api/auth/reset-password/reset-password.schema';
