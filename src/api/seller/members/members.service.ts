...
import {
  ...
  isOwnerSellerRoleId,
} from '@/domains/identity/application/access/seller/role-queries';
...
import { sendSellerMemberInviteEmail } from '@/domains/identity/application/mail/send-member-invite';
import type { SellerAccessContext } from '@/domains/identity/application/queries/seller-context';
import type { CreateSellerMemberInput } from '@/api/seller/members/create-member.schema';
import type {
  UpdateSellerMemberProfileInput,
  UpdateSellerMemberRoleInput,
} from '@/api/seller/members/create-member.schema';
