...
import { invalidateCatalogCache } from '@/shared/cache/catalog-cache';
import {
...
import {
  addCategoryLink,
  removeCategoryLink,
} from '@/domain/catalog/category/category-links';
import { getCategoryPaths } from '@/domain/catalog/category/public-categories';
