...
import { getCategoryProductFilterIds } from '@/domain/catalog/category/product-category-filters';
import { escapeRegex } from '@/shared/validation/escape-regex';
import { isCategoryPubliclyVisible, getPublicVisibleCategoryIds } from '@/domain/catalog/category/visible-categories';
import { toPublicProductResponse } from '@/domain/catalog/product/product-response';
...
import type { ListProductsQuery } from '@/domain/catalog/product/list-products.schema';
