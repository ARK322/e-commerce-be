...
import { assertProductCategory } from '@/domain/catalog/category/product-category-validation';
import { slugify } from '@/domain/catalog/category/slugify';
import { toSellerProductResponse } from '@/domain/catalog/product/product-response';
import {
  deleteProductImagesFromStorage,
  uploadProductImage,
  deleteProductImage,
} from '@/domain/catalog/product/product-images';
import type { ProductImageUpload } from '@/domain/catalog/product/product-image-types';
import { invalidateCatalogProductCache } from '@/shared/cache/catalog-cache';
import type {
  CreateProductInput,
  UpdateProductInput,
