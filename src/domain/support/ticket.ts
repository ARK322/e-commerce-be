...
} from '@/domain/support/support.schemas';
import type {
  ListSupportMessagesQuery,
  ListSupportTicketsQuery,
  UpdateSupportTicketInput,
} from '@/domain/support/support-query.schemas';
...
const findSupportTicketByIdOrThrow = async (ticketId: string) => {
